...
Recoding our response variable to "0" if change in black population is <= "-6.765" or one standard deviation below the mean and equal to "1" if >  "6.765" in order visualize and eventually create a logistic model:
